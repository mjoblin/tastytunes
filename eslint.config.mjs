  ...
  ...tseslint.configs.recommendedTypeChecked,
  {
    ...
    rules: {
      ...
      '@typescript-eslint/restrict-template-expressions': [
        'error',
        { allowNumber: true, allowBoolean: true, allowNullish: true, allowRegExp: true, allowAny: true },
      ],
      ...
      // Untyped boundaries (JSON.parse of our own files, the XML parser, MCP
      // args): real work to narrow properly — WARN for now so the count is
      // visible, not blocking; tracked in the ROADMAP.
