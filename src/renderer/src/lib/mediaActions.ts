 ...
 */
export async function recordPresetSaved(ref: MediaRef, slot: number, name: string | null): Promise<void> {
 ...
 */
export async function saveRefToPreset(ref: MediaRef, slot: number, name: string | null): Promise<void> {
  const showToast = useStore.getState().showToast
